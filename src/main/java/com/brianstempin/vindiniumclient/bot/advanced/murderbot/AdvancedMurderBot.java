...
public class AdvancedMurderBot implements AdvancedBot {
    ...
    public AdvancedMurderBot() {
        ...
        GreedyAlgorithm greedyAlgorithmDecisioner = new GreedyAlgorithm(botTargetingDecisioner);
        EnRouteLootingDecisioner enRouteLootingDecisioner = new EnRouteLootingDecisioner(greedyAlgorithmDecisioner);
